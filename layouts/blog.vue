    ...
    <header class="bg-white shadow-sm">
      <div class="container-main py-4">
        <div class="flex items-center justify-between">
          ...
          <a href="#main-content"
            class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-white px-4 py-2 z-50">
            Hoppa till innehåll
          </a>
            ...
            <div class="flex flex-col md:flex-row md:justify-between">
              <div class="mb-6 md:mb-0">
                ...
                <div class="flex flex-wrap gap-2">
                  <NuxtLink v-for="tag in blogTags" :key="tag" :to="`/blog/tag/${tag}`"
              ...
              <div>
                <h2 class="text-xl font-semibold mb-4">Dela</h2>
                <div class="flex space-x-4">
                  <button class="text-neutral-600 hover:text-primary" aria-label="Dela på Twitter">
                  ...
                  <button class="text-neutral-600 hover:text-primary" aria-label="Dela på LinkedIn">
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path fill-rule="evenodd"
                  ...
                  <button class="text-neutral-600 hover:text-primary" aria-label="Kopiera länk">
      ...
      <div class="container-main py-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li>
                <NuxtLink to="/om" class="text-neutral-600 hover:text-primary">Om T12T</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/kontakt" class="text-neutral-600 hover:text-primary">Kontakt</NuxtLink>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div class="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/company/t12t" class="text-neutral-600 hover:text-primary"
                aria-label="LinkedIn">
                <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fill-rule="evenodd"
                    d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"
