        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li>
                <NuxtLink to="/om/kontakt" class="text-neutral-600 hover:text-primary">Kontakt</NuxtLink>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div class="flex space-x-4">
              <a href="https://github.com/thwestlund/t12t" class="text-neutral-600 hover:text-primary"
                aria-label="GitHub">
              ...
              <a href="https://www.linkedin.com/in/thommy-westlund-02090650/"
                class="text-neutral-600 hover:text-primary" aria-label="LinkedIn">
                <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fill-rule="evenodd"
