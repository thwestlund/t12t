<template>
  <header class="bg-white shadow-sm">
    <div class="py-3 px-4 lg:px-6 lg:py-3">
      <div class="flex items-center justify-between">
        ...
        <button 
          ...
          <svg 
            class="h-7 w-7" :class="{ 'hidden': isMenuOpen, 'block': !isMenuOpen }" stroke="currentColor" fill="none"
            viewBox="0 0 24 24" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
          </svg>
          <svg 
            class="h-7 w-7" :class="{ 'block': isMenuOpen, 'hidden': !isMenuOpen }" stroke="currentColor" fill="none"
            viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div 
      id="mobile-menu" class="md:hidden" :class="{ 'block': isMenuOpen, 'hidden': !isMenuOpen }"
